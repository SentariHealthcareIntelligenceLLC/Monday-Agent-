...
INSERT INTO schema_migrations (filename) VALUES ('007_delivery_status_monotonic.sql')
...
INSERT INTO schema_migrations (filename) VALUES ('20260907000006_delivery_status_monotonic.sql')
ON CONFLICT (filename) DO NOTHING;
